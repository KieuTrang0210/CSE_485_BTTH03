...
-- Dumping database structure for article_website
CREATE DATABASE IF NOT EXISTS `article_website` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `article_website`;

-- Dumping structure for table article_website.article
...
-- Dumping data for table article_website.article: ~24 rows (approximately)
...
-- Dumping structure for table article_website.category
...
-- Dumping data for table article_website.category: ~4 rows (approximately)
...
-- Dumping structure for table article_website.image
...
-- Dumping data for table article_website.image: ~23 rows (approximately)
...
-- Dumping structure for table article_website.member
...
-- Dumping data for table article_website.member: ~3 rows (approximately)
